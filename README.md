...
Restaurant App is containerized polyglot microservices application that contains projects based on .NET Core, Golang, Java, Xamarin, React, Angular and etc. The project demonstrates how to develop small microservices for larger applications using containers, orchestration, service discovery, gateway, and best practices. You are always welcome to improve code quality and contribute to it, if you have any questions or issues don't hesitate to ask in our [gitter](https://gitter.im/Restaurant-App-Community/community?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge) chat.

To get started, simply fork this repository. Please refer [CONTRIBUTING.md](CONTRIBUTING.md) for contribution guidelines.

## Motivation

- Developing independently deployable and scalable microservices based on best practies using containerization ☸ 🐳 
...
- Using modern technologies such as GraphQL, gRPC, Apache Kafka, Serverless and Istio
...
| 2. | Cart API (Golang + Redis)                  | Manages customer basket in order to keep items in an in-memory cache using redis | ![Build Status](https://github.com/chayxana/Restaurant-App/actions/workflows/cart-api.yml/badge.svg)       | [dev](#) \| [prod](#) |
| 3. | Catalog API (Rust + Rocket, PostgreSQL)    | Manages data for displaying restaurant menu                                      | ![Build Status](https://github.com/chayxana/Restaurant-App/actions/workflows/catalog-api.yml/badge.svg)    | [dev](#) \| [prod](#) |
...
## Mobile app
[Unfortunately, I am no longer be able to maintain the Xamarin(mobile) part](https://github.com/chayxana/Restaurant-App/issues/81)
...
The example shows how to develop beautiful user interfaces using Xamarin.Forms and how to manage your code with Clean Architecture on the mobile side to achieve clean, maintainable and testable code.
