...
namespace Identity.API.IntegrationTests.Config
{
    public class IdentityServerSetup
    {
		...
		private void ConfigureIdentityServerServices(IServiceCollection services)
        {
            services.AddIdentityServer()
                ...
                .AddInMemoryIdentityResources(Restaurant.Server.Api.IdentityServer.Config.GetIdentityResources())
                .AddInMemoryApiResources(Restaurant.Server.Api.IdentityServer.Config.GetApiResources())
                .AddInMemoryClients(Restaurant.Server.Api.IdentityServer.Config.GetClients())
