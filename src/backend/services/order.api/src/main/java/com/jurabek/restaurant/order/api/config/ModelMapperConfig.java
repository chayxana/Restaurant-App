...
public class ModelMapperConfig {
  ...
  public ModelMapper modelMapper() {
    ...
    modelMapper
        .createTypeMap(CustomerBasketDto.class, Order.class)
        .addMappings(customerBasketToOrderMap);

    modelMapper.createTypeMap(OrderItems.class, CustomerOrderItemsDto.class);
    modelMapper
        .createTypeMap(Order.class, CustomerOrderDto.class)
        .addMappings(orderToCustomerOrderDto);
