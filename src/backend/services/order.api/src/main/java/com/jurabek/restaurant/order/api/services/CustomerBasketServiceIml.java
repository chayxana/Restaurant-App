...
public class CustomerBasketServiceIml implements CustomerBasketService {
  ...
  @Autowired
  public CustomerBasketServiceIml(
      RestTemplate restTemplate, EndpointsConfiguration endpointsConfiguration) {
  ...
  public void clearCustomerBasket(String customerId) {
    ...
    this.restTemplate.delete(basketUrl + "/api/v1/items/{customerId}", customerId);
  }
}
