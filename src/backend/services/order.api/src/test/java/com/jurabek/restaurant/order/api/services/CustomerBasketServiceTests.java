...
public class CustomerBasketServiceTests {
  @Mock EndpointsConfiguration configuration;

  @Mock RestTemplate restTemplate;

  @InjectMocks CustomerBasketServiceIml customerBasketService;

  @Test
  @Ignore
  public void
      clearCustomerBasket_Should_Send_Http_Request_to_Basket_API_and_clean_basket_by_customer_id() {
    // Arrange
